  ...
  return (
    <div className={styles.banner} role="status" aria-live="polite">
      ...
      <span className={styles.text}>
        Сайт работает в тестовом режиме, идёт разработка. Это пока не настоящий сайт и тут пока ничего нет. Расходитесь, здесь пока не на что смотреть (но вы всё равно посмотрите, прикольно, да?)
      </span>
    </div>
  );
}
